...
class RodaGigante2 extends StatefulWidget {
  const RodaGigante2({Key? key}) : super(key: key);
  @override
  State<RodaGigante2> createState() => _RodaGigante2State();
}

class _RodaGigante2State extends State<RodaGigante2> {
  ...
  void sendMessageBluetooth(String text) async {
    print('sending data');
    showSnackBar('Enviando para placa');
    if (isConnected) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Column(
                    children: [
                      const Text('SENSOR ULTRASÔNICO'),
                      Image.asset(
                        'assets/images/ultrasonico.png',
                        height: 100,
                      ),
                    ],
                  ),
              ...
              Row(
                ...
                children: [
                  Column(
                    children: [
                      const Text('Potenciômetro'),
                      Image.asset(
                        'assets/images/potenciometro.png',
                        height: 100,
                      ),
                    ],
                  ),

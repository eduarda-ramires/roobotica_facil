...
class CarrinhoPet extends StatefulWidget {
  const CarrinhoPet({Key? key}) : super(key: key);
  @override
  State<CarrinhoPet> createState() => _CarrinhoPetState();
}

class _CarrinhoPetState extends State<CarrinhoPet> {
